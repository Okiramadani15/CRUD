...
app.get('/', (req, res) => { //create router create read
  res.render('list', { obj })
})
...
app.get('/delete/:index', (req, res) => {  //create router create delete
  const index = req.params.index
  obj.splice(index, 1)
  fs.writeFileSync('./data/ data.json', JSON.stringify(obj),'utf-8')
  res.redirect('/')
})

app.get('/edit/:index', (req, res) => { //create router create edit
  const index = req.params.index
